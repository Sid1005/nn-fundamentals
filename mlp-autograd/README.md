...
**2. Backpropagation** — starting from the loss, the chain rule is applied in reverse topological order across the computation graph. Each node accumulates `∂loss/∂self` from its downstream consumers.
